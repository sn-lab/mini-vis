...
cs.expname = 'contrast_tuning_test1';
cs.directory = 'C:\Users\Matthew\Documents\Schaffer-Nishimura Lab\Visual Stimulation\Data';
cs.trial_duration = 6;
cs.conditions = [30 27 24 21 18 17 16 15]; %bar1 blue intensity (for 100, 80, 60, 40, 20, 13, 7, and 0 % contrast)
cs.num_reps = 3;
...
for rep = 1:cs.num_reps
    for trial = 1:cs.num_trials
        ...
        cs.rep = rep;
        cs.trial = trial;
        cs.param.bar1color(3) = cs.conditions(order(rep,trial));
        cs.param.bar2color(3) = 30 - cs.param.bar1color(3);
