function vs = matlab2arduinoVis(vs, param)
%FUNCTION vs = matlab2arduinoVis(vs, param)
%
% Function to send grating parameters from Matlab to arduinoVis.
%
% Parameter list
...
assert(param.patterntype>0 && param.patterntype<7 && mod(param.patterntype,1)==0,'pattern type must be an integer between 1-6');
